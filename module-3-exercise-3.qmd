...
**Course Title**: Econ 106 Computer programming for economcis <br> **Instructor**: Christopher Llones <br> **Exercise**:Replicating a World Bank figure using ggplot2 <br> **Due Date**: 22 March 2026
...
1. Download the dataset: [hlo_database.xlsx](https://humancapital.worldbank.org/en/building-human-capital-where-it-matters) (from the World Bank Data Catalog).
